    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblBillingAddress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillingAddresses_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblShippingAddress", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblBillingAddress_CustomerId",
                schema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblShippingAddress_CustomerId",
                schema: "dbo",
