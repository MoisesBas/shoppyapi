...
namespace ShoppyEx.Customer.Api.Protos {
  public static partial class AddressGrpc
  {
    ...
    [grpc::BindServiceMethod(typeof(AddressGrpc), "BindService")]
    public abstract partial class AddressGrpcBase
    {
    }
    ...
    public static grpc::ServerServiceDefinition BindService(AddressGrpcBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, AddressGrpcBase serviceImpl)
    {
    }
